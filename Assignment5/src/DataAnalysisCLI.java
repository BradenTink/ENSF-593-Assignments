...
/**
 * @Braden Tink
 * DataAnalysisCLI class 
 * Has to two class varialbes DataFrame Data, InteractiveLCLI cli 
 * 
 **/
public class DataAnalysisCLI{
	...
	/**
	 *Constructor for DataAnaylsisCLI
	 *Creates a new interactiveCLI cli 
	**/
	...
	public void run() {
		...
		//We ask the user to select a column by index
...
//		//Checking if user selected a valid column index
		if(col>=0 && col < data.getNumOfCols()) {
			...
			//Display data series information in the display area 
	 ...
	 * Main 
	 * @param args
	 * Creates a DataAnaylsisCLI object called app abd runs it.
	 */
